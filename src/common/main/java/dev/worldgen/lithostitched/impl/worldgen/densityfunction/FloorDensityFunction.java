...
public class FloorDensityFunction extends TransformerDensityFunction {
    public static final MapCodec<FloorDensityFunction> DATA_CODEC = DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument").xmap(FloorDensityFunction::new, FloorDensityFunction::argument);
