...
public class CosDensityFunction extends TransformerDensityFunction {
    public static final MapCodec<CosDensityFunction> DATA_CODEC =  DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument").xmap(CosDensityFunction::new, CosDensityFunction::argument);
