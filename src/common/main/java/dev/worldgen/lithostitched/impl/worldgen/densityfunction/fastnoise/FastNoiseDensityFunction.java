package dev.worldgen.lithostitched.impl.worldgen.densityfunction.fastnoise;
...
public record FastNoiseDensityFunction(Holder<FastNoiseConfig> config, double xzScale, double yScale, DensityFunction shiftX, DensityFunction shiftY, DensityFunction shiftZ) implements DensityFunction {
    public static final MapCodec<FastNoiseDensityFunction> DATA_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(
        ...
        DensityFunction.HOLDER_HELPER_CODEC.optionalFieldOf("shift_x", DensityFunctions.zero()).forGetter(FastNoiseDensityFunction::shiftX),
        DensityFunction.HOLDER_HELPER_CODEC.optionalFieldOf("shift_y", DensityFunctions.zero()).forGetter(FastNoiseDensityFunction::shiftY),
        DensityFunction.HOLDER_HELPER_CODEC.optionalFieldOf("shift_z", DensityFunctions.zero()).forGetter(FastNoiseDensityFunction::shiftZ)
