...
public class SinDensityFunction extends TransformerDensityFunction {
    public static final MapCodec<SinDensityFunction> DATA_CODEC =  DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument").xmap(SinDensityFunction::new, SinDensityFunction::argument);
