...
public record MixDensityFunction(DensityFunction input, DensityFunction argument1, DensityFunction argument2) implements DensityFunction {
	public static final MapCodec<MixDensityFunction> DATA_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
		DensityFunction.HOLDER_HELPER_CODEC.fieldOf("input").forGetter(MixDensityFunction::input),
		DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument1").forGetter(MixDensityFunction::argument1),
		DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument2").forGetter(MixDensityFunction::argument2)
