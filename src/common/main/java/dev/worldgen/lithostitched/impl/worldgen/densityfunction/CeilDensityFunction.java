...
public class CeilDensityFunction extends TransformerDensityFunction {
    public static final MapCodec<CeilDensityFunction> DATA_CODEC =  DensityFunction.HOLDER_HELPER_CODEC.fieldOf("argument").xmap(CeilDensityFunction::new, CeilDensityFunction::argument);
