...
public interface LithostitchedTemplatePoolTags {
	TagKey<StructureTemplatePool> TRIAL_SPAWNER_MELLE = create("trial_spawner/melee");
	TagKey<StructureTemplatePool> TRIAL_SPAWNER_SMALL_MELLE = create("trial_spawner/small_melee");
