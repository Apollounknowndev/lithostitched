...
public record LargeDripstoneConfig(BlockStateProvider stateProvider, HolderSet<Block> replaceableBlocks, int floorToCeilingSearchRange, IntProvider columnRadius, FloatProvider heightScale, float maxColumnRadiusToCaveHeightRatio, FloatProvider stalactiteBluntness, FloatProvider stalagmiteBluntness, FloatProvider windSpeed, int minRadiusForWind, float minBluntnessForWind) implements FeatureConfiguration {
    public static final Codec<LargeDripstoneConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        LithostitchedVersion.intProviderCodec(1, 60).fieldOf("column_radius").forGetter(LargeDripstoneConfig::columnRadius),
        LithostitchedVersion.floatProviderCodec(0.0F, 20.0F).fieldOf("height_scale").forGetter(LargeDripstoneConfig::heightScale),
        ...
        LithostitchedVersion.floatProviderCodec(0.1F, 10.0F).fieldOf("stalactite_bluntness").forGetter(LargeDripstoneConfig::stalactiteBluntness),
        LithostitchedVersion.floatProviderCodec(0.1F, 10.0F).fieldOf("stalagmite_bluntness").forGetter(LargeDripstoneConfig::stalagmiteBluntness),
        LithostitchedVersion.floatProviderCodec(0.0F, 2.0F).fieldOf("wind_speed").forGetter(LargeDripstoneConfig::windSpeed),
