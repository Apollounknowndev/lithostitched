...
public record TagFilledCondition(HolderSet<SurfaceRules.RuleSource> rules) implements SurfaceRules.ConditionSource {
    public static final MapCodec<TagFilledCondition> CODEC = RegistryCodecs.homogeneousList(LithostitchedRegistries.SURFACE_RULE).fieldOf("tag").xmap(TagFilledCondition::new, TagFilledCondition::rules);
