package dev.worldgen.lithostitched.impl.worldgen.poolelement;
...
public record DelegatingConfig(
    ...
    Heightmap.Types terrainMatchingHeightmap,
    ...
    public static final MapCodec<DelegatingConfig> CODEC = RecordCodecBuilder.<DelegatingConfig>mapCodec(instance -> instance.group(
        ...
        Heightmap.Types.CODEC.optionalFieldOf("terrain_matching_heightmap", Heightmap.Types.WORLD_SURFACE_WG).forGetter(DelegatingConfig::terrainMatchingHeightmap),
