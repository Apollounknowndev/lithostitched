...
public class BranchedMegaPineFoliagePlacer extends MegaPineFoliagePlacer {
    public static final MapCodec<BranchedMegaPineFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(i -> foliagePlacerParts(i).and(
        IntProviders.codec(0, 24).fieldOf("crown_height").forGetter(placer -> placer.crownHeight)
    ).apply(i, BranchedMegaPineFoliagePlacer::new));
