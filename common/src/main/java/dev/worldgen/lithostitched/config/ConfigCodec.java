...
public record ConfigCodec(String commentA, String commentB, String commentC, boolean breaksSeedParity) {
    ...
    public static final ConfigCodec DEFAULT = new ConfigCodec(COMMENT_A, COMMENT_B, COMMENT_C,  true);
}
