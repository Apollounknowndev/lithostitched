...
public record NotStructureCondition(StructureCondition condition) implements StructureCondition {
    public static final MapCodec<NotStructureCondition> CODEC = StructureCondition.CODEC.fieldOf("condition").xmap(NotStructureCondition::new, NotStructureCondition::condition);
