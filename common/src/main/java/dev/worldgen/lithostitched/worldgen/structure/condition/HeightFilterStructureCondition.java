...
public record HeightFilterStructureCondition(RangeType rangeType, Optional<Heightmap.Types> heightmap, InclusiveRange<Integer> permittedRange) implements StructureCondition {
    public static final MapCodec<HeightFilterStructureCondition> CODEC = RecordCodecBuilder.<HeightFilterStructureCondition>mapCodec(instance -> instance.group(
    ...
    ).apply(instance, HeightFilterStructureCondition::new)).validate(HeightFilterStructureCondition::validate);
