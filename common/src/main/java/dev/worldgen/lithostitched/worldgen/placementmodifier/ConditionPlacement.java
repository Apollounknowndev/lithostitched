...
public class ConditionPlacement extends PlacementFilter {
    public static final Codec<ConditionPlacement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        PlacementCondition.CODEC.fieldOf("condition").forGetter(ConditionPlacement::condition)
    ).apply(instance, ConditionPlacement::new));
