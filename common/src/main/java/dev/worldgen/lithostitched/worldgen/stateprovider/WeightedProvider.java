...
public final class WeightedProvider extends BlockStateProvider {
    public static final Codec<WeightedProvider> CODEC = SimpleWeightedRandomList.wrappedCodec(BlockStateProvider.CODEC).fieldOf("entries").xmap(WeightedProvider::new, WeightedProvider::providers).codec();
