...
public record MatchingBlocks(HolderSet<Block> blocks, AlternatePropertiesPredicate properties, BlockType matchType) implements ProcessorCondition {
    private static final AlternatePropertiesPredicate DEFAULT_PREDICATE = new AlternatePropertiesPredicate(List.of());
    public static final MapCodec<MatchingBlocks> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
        ...
        AlternatePropertiesPredicate.CODEC.fieldOf("properties").orElse(DEFAULT_PREDICATE).forGetter(MatchingBlocks::properties),
