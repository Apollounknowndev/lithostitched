...
public final class RandomBlockProvider extends BlockStateProvider {
    public static final Codec<RandomBlockProvider> CODEC = LithostitchedCodecs.BLOCK_SET.fieldOf("blocks").xmap(RandomBlockProvider::new, RandomBlockProvider::blocks).codec();
